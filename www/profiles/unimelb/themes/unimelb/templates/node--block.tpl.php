...
if($view_mode != 'full') { print '<div class="polaroid">'; }
...
if(!$teaser) { print render($content['field_url']); }

if ($view_mode != 'full') { print '<a class="button" href="' . $the_url . '" ' . $the_url_target . '>Read more</a>'; }

print render($content['links']); 

print render($content['comments']); 

if($view_mode != 'full') { print '</div>'; }
