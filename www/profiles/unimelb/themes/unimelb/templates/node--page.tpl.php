...
$thedate = field_get_items('node', $node, 'field_date');
$thedate_value = field_view_value('node', $node, 'field_date', $thedate[0], $date_display_settings);
*/
...
print render($content['field_related_pages']);
print render($content['field_related_urls']);
